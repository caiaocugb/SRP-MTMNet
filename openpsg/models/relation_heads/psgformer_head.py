...
class PSGFormerHead(AnchorFreeHead):
    ...
    def __init__(self,
        ...
        self.fpn_channels = tuple(fpn_channels)
        if len(self.fpn_channels) != 3:
            raise ValueError('fpn_channels must contain exactly three values')
